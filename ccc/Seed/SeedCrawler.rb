...
module SeedCrawler
  ...
  def SeedCrawler.run
    ...
    # データの用意
    key_words = KeyWordMaker.make_key_words
    seed_urls = []
    key_words.each {|keyword|
      seed_urls << "https://www.google.co.jp/search?q=" + keyword +
      ...
      keyword + "&safe=off&tbs=lr:lang_1vi&start="
    }
